...
export function PendingReadingDisplay({ 
  ...
  const handleViewFullReading = () => {
    if (reading) {
      ...
      router.push(`/tarot/${matchId}/reading/${reading.id}${suffix}`)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-black text-white p-4 md:p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <Card className="border-2 bg-white/10 backdrop-blur text-white">
            ...
            <CardContent className="space-y-6">
              <div className="p-4 bg-red-900/30 border border-red-500/40 rounded-lg text-red-200 text-sm">
                {error}
              </div>
              <div className="text-center">
                <Button asChild>
                  <Link href={`/tarot/${matchId}${from ? `?from=${encodeURIComponent(from)}` : ''}`}>
                    Try Again
                  </Link>
                </Button>
              </div>
        ...
        <div className="flex min-h-[70vh] items-center justify-center">
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="relative">
              <div className={`relative aspect-[2/3] w-[70vw] max-w-[420px] md:max-w-[520px] lg:max-w-[640px] rounded-xl`}>
            ...
            {isLoading ? (
              <div className="text-center space-y-2">
                ...
                <p className="text-white/80">Channeling cosmic wisdom...</p>
              </div>
            ) : (
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                {reading && showText && (
                  <div className="space-y-4">
                    <div className="text-center">
                      <h3 className="text-xl font-serif text-white mb-3">Your Reading</h3>
